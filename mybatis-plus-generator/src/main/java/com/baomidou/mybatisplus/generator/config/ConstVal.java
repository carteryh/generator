...
public interface ConstVal {
     ...
     * addDto模板路径
     */
    String TEMPLATE_ADD_DTO = "/templates/adddto.java";

    /**
     * updDto模板路径
     */
    String TEMPLATE_UPDATE_DTO = "/templates/upddto.java";

    /**
     * pageinDto模板路径
     */
    String TEMPLATE_PAGEIN_DTO = "/templates/pageindto.java";

    /**
     * pageoutDTO模板路径
     */
    String TEMPLATE_PAGEOUT_DTO = "/templates/pageoutDto.java";
