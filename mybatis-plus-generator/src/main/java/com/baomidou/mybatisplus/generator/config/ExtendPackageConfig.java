 ...
 * @since 2016-08-30
 */
public class ExtendPackageConfig {

    private ExtendPackageConfig() {
    }
     ...
     * @since 3.5.0
     */
    public static class Builder implements IConfigBuilder<ExtendPackageConfig> {

        private final ExtendPackageConfig packageConfig;

        public Builder() {
            this.packageConfig = new ExtendPackageConfig();
        }
         ...
         */
        @Override
        public ExtendPackageConfig build() {
