 ...
 * @since 2017-06-17
 */
public class ExtendTemplateConfig extends TemplateConfig {

    private static final Logger LOGGER = LoggerFactory.getLogger(ExtendTemplateConfig.class);
     ...
     * @since 3.3.2
     */
    public ExtendTemplateConfig disable(@NotNull TemplateType... templateTypes) {
     ...
     */
    public static class Builder implements IConfigBuilder<ExtendTemplateConfig> {

        private final ExtendTemplateConfig templateConfig;

        /**
         * 默认生成一个空的
         */
        public Builder() {
            this.templateConfig = new ExtendTemplateConfig();
        }
         ...
         */
        @Override
        public ExtendTemplateConfig build() {
